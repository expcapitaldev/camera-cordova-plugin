...
public class CustomCamera extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) {
        ...
        if ("takePicture".equals(action)) {
            ...
            takePicture(title, subtitle, cancel, msg, type);
        }
        return true;
    }

    private void takePicture(String title, String subtitle, String cancel, String msg, ViewfinderView.Type type) {
        cordova.startActivityForResult(this, CameraActivity.prepareIntent(cordova.getActivity(), title, subtitle, cancel, msg, type), CAMERA_REQUEST_CODE);
    }
